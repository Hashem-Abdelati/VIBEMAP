...
Hot Map NYC is a real-time social city pulse map for New York City. Users discover the live vibe of places before they go — coffee shops, libraries, gyms, bars, parks, and more — through fast community "pings" from people who are there right now.
...
## 📡 Real-time Architecture (MVP)

The current MVP uses **polling** (30-second intervals on the live feed). Production should upgrade to:

- **Option A:** Supabase Realtime (easiest)
- **Option B:** Socket.io with Redis pub/sub
- **Option C:** Pusher / Ably

The notification and ping structures are designed to support any of these.
...
4. Use [Neon](https://neon.tech) or [Railway](https://railway.app) for PostgreSQL
